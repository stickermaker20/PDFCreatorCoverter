...
import static pdfconvertores.com.pdfcreatorcoverter.util.Constants.LAUNCH_COUNT;
                ...
                .setPositiveButton(mContext.getString(R.string.rate_positive),
                        (dialogInterface, i) -> {
                            try {
                                ...
                                openWebPage("https://play.google.com/store/apps/details?id=vehicalsregisteration.com.pdfcreatorcoverter");
                            }
