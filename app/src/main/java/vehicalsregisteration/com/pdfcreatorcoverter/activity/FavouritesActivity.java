...
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.ADD_IMAGES_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.ADD_PASSWORD_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.ADD_WATERMARK_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.COMPRESS_PDF_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.EXCEL_TO_PDF_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.EXTRACT_IMAGES_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.HISTORY_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.IMAGE_TO_PDF_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.INVERT_PDF_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.MERGE_PDF_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.PDF_TO_IMAGES_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.QR_BARCODE_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.REMOVE_PAGES_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.REMOVE_PASSWORD_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.REORDER_PAGES_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.ROTATE_PAGES_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.SPLIT_PDF_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.TEXT_TO_PDF_KEY;
import static vehicalsregisteration.com.pdfcreatorcoverter.util.Constants.VIEW_FILES_KEY;
